...
int main() {
    ...
    for (int cycle = 0; cycle < NUM_TESTS; ++cycle) {
        try {
            ...
            // Show x0..x31 (your CPU only has 32 regs)
            for (int r = 0; r < 32; ++r) {
            ...
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(16));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(17));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(18));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(19));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(20));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(21));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(22));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(23));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(24));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(25));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(26));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(27));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(28));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(29));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(30));
            registerOutFile << std::bitset<32>(emulator.GetRegisterValue(31));
