...
private:
    std::vector<uint32_t>       registers_          = std::vector<uint32_t>(16, 0); // 4 registers
    std::vector<uint32_t>       instruction_memory_ = std::vector<uint32_t>(16777215, 0); // 2^26 memory locations
